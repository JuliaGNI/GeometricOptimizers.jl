...
#     _BFGS  Backtracking(expand)     95 /   118        2_431 /  3_021     104..161 / 114..156
#     _BFGS  Backtracking            136 /   136        3_447 /  3_446     114..192 / 131..203
#     _BFGS  Bisection               133 /    92       78_648 / 54_970       87..133 /  89..135
#     _DFP   Backtracking(expand)   768 / 1_366       19_991 / 35_329     385..1_118 / 466..1_366
#     _DFP   Backtracking        47_115 / 26_479    1_177_919 / 662_019  10_448..114_116 / 5_596..26_479
#     _DFP   StrongWolfe(c₂=0.1)    218 /   279       18_117 / 23_818      296..868 / 215..447
#     _DFP   Bisection               136 /    96       79_991 / 56_106       87..141 /  88..129
#
...
# directions and the `Cayley` column, which the fix does not touch, is unchanged to the digit. The
# figures are regenerated by `scripts/retraction_accuracy.jl`, which measures the same matrix this
# file does -- it is `svd_matrix.jl` for both.
#
