...
# one-process-per-variant form and is what the ratio in `CHANGELOG.md` was confirmed against:
#
#     julia --startup-file=no --project=. scripts/cayley_regrouping_cost.jl old
#     julia --startup-file=no --project=. scripts/cayley_regrouping_cost.jl new
#
